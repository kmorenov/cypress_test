...
// Therefore, as a workaround we polyfills `fetch` with traditional XHR which
...
function enableFetchWorkaround() {
    ...
    before(() => {
        console.info('Load fetch XHR polyfills')
    ...
    Cypress.on('window:before:load', (win) => {
        delete win.fetch
        // since the application code does not ship with a polyfills
